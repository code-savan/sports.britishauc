    ...
    <section className="min-h-screen bg-gray-50 pt-16">
      ...
      <div className="bg-gray-900 py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h1 className="text-3xl md:text-5xl font-semibold text-white leading-tight mb-4">Medical Profile</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-20">
        <div className="border border-gray-100 bg-white p-8">
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-6">Personal Information</h2>
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-6">Family Medical History</h2>
              <div className="mb-4">
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-6">Personal Medical History</h2>
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-6">Neurology and Concussion Questions</h2>
            ...
            {/* Previous Injuries */}
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-6">Previous Injuries</h2>
              <div className="overflow-x-auto border border-gray-100">
                <table className="min-w-full bg-white text-sm">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="py-3 px-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Injury sustained</th>
                      <th className="py-3 px-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider">Left Side</th>
                      <th className="py-3 px-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider">Right Side</th>
                      <th className="py-3 px-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider">No previous injury</th>
                    </tr>
                  </thead>
                  <tbody>
                    {initialInjuries.map((injury, idx) => (
                      <tr key={injury} className="even:bg-gray-50">
                        <td className="py-2 px-3 text-sm text-gray-500">{injury}</td>
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-6">Medical and Allergies</h2>
              <div className="grid md:grid-cols-2 gap-6">
                {/* Prescription (left) */}
                <div>
                  ...
                  <div className="mt-4 grid gap-4">
                    {['prescriptionDetails','prescriptionReason','prescriptionDuration','prescriptionCurrent','prescriptionWho'].map((field) => (
                      <div key={field}>
                        <Label htmlFor={field}>{
            ...
            {/* Athlete Declaration */}
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-6">Athlete Declaration</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-6">Parental Declaration</h2>
            ...
            <div className="pt-6 flex justify-end">
              <button
                type="submit"
                disabled={submitting}
                className="bg-red-600 hover:bg-red-700 text-white text-sm font-medium px-5 py-2.5 disabled:bg-red-400 disabled:cursor-not-allowed transition"
              >
