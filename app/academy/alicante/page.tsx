      ...
      <section className="py-24 bg-primary">
        <div className="container max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-base text-white/90 max-w-3xl mx-auto mb-12">
            B-SPORT connects with various Spanish and European league clubs, academies, and Scouts on a regular basis to ensure that our players have many opportunities and exposure to becoming professional footballers.
          </p>
