      ...
      <section className="relative h-[70vh] md:h-[80vh] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full text-white">
          <div className="max-w-xl">
            ...
            <h1 className="text-3xl md:text-5xl font-semibold text-white leading-tight mb-4">NIKE BASKETBALL CAMPS</h1>
            <p className="text-sm md:text-[15px] text-white/60 leading-relaxed">LONDON BASKETBALL TRIP 2025</p>
          </div>
        </div>
      </section>
...
<div className="inline-block mb-2">
  <span className="border border-gray-200 py-1 px-2 text-[11px] text-gray-500">Event Details</span>
                ...
                <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">PROFESSIONAL BASKETBALL EXPERIENCE</h2>
              ...
              <div className="border border-gray-100 p-8">
                <h2 className="text-base font-semibold text-gray-900 mb-3">PLAYER DEVELOPMENT</h2>
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">NIKE BASKETBALL CAMPS</h2>
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">NOT INCLUDED</h2>
                <ul className="space-y-3 text-sm md:text-[15px] text-gray-500 leading-relaxed">
                  <li className="flex items-start">
                    <svg className="h-6 w-6 text-red-600 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="md:col-span-1">
              <div className="border border-gray-100 p-8 sticky top-24">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-red-600">£4,950</p>
                ...
                <Link href="/events/london-basketball-trip/register" className="w-full bg-red-600 hover:bg-red-700 text-white text-sm font-medium px-5 py-2.5 inline-block text-center">
                  Register Now
                </Link>
              </div>
            </div>
