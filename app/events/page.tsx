...
const events = [
  {
    ...
    date: 'TBD (Deadline: 15th April 2025)',
    ...
    <div className="pt-16">
      ...
      <section className="relative h-[50vh] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white text-center">Football Opportunities</h1>
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-blue-50 to-gray-50 rounded-xl p-8 max-w-3xl mx-auto shadow-sm">
              ...
              <p className="text-gray-600 mb-6">
                We can organize custom football experiences for teams, schools, or groups. Contact us to discuss your requirements.
              </p>
