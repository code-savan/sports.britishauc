      ...
      <section className="relative h-[70vh] md:h-[80vh] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-xl">
            ...
            <h1 className="text-3xl md:text-5xl font-semibold text-white leading-tight mb-4">MANCHESTER FOOTBALL TRIAL 2026</h1>
            <p className="text-sm md:text-[15px] text-white/60 leading-relaxed">SHOWCASE YOUR TALENT AND BE SCOUTED!</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">VENUE</h2>
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed mb-4">
            ...
            <div className="md:col-span-1">
              <div className="bg-white p-8 sticky top-24 border border-gray-100">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-red-600">£65</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <Link
                  href="/events/football-trial-2025/register?event=manchester2026"
