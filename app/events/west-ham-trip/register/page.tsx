...
const supabase = createClient(
  ...
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY,
  {
    ...
    global: {
      ...
      headers: { 'x-application-name': 'west-ham-registration' }
    }
  }
);
...
export default function ManchesterTrialRegistrationPage() {
  ...
  const onSubmit = async (data: ExtendedFormData) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push('/events/west-ham-trip/registration-success');
      }, 2000);
    } catch (error) {
      ...
      <section className="relative h-[30vh] flex items-center">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Manchester Football Trial Registration"
            fill
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
          <div className="inline-block mb-4">
            <span className="bg-primary text-white text-sm font-medium px-3 py-1 rounded-full">Registration Form</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-bold mb-4 text-white">West Ham United Summer Trip 2025</h1>
              ...
              <div className="flex justify-between mt-8">
                ...
                {step < totalSteps ? (
                  <Button
                    type="button"
                    onClick={nextStep}
                    className="ml-auto flex items-center hover:bg-red-700"
                  >
                    Next
                  ...
                  <Button
                    type="submit"
                    className="ml-auto bg-primary hover:bg-red-700"
