      ...
      <div className="min-h-screen bg-white pt-16">
        ...
        <div className="bg-gray-900 py-20 md:py-28">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-medium text-white/60 tracking-[0.15em] uppercase">Legal</span>
            </div>
            ...
            <p className="text-sm md:text-[15px] text-gray-400 max-w-2xl leading-relaxed">
              British AUC Sport - Programme Terms &amp; Conditions
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 md:py-28">
          <div className="space-y-16">
            {/* Section 1: Bookings */}
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">1. Bookings</h2>
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">2. Cancellations</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
                  All cancellations must be made in writing and will be confirmed in writing by British AUC Sport.
                </p>
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed font-medium">
                  Cancellations are subject to the following charges:
                </p>

                <div className="border border-gray-100 p-8 space-y-6">
                  <div>
                    <h4 className="text-sm font-semibold text-gray-900 mb-3">a. Individuals:</h4>
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-gray-900 mb-3">b. Groups:</h4>
                    <ul className="space-y-2 text-sm md:text-[15px] text-gray-500 leading-relaxed">
                      <li>
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">3. Conditions</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">4. Liability and Insurance</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">5. Acceptance Conditions</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            {/* Section 6: Behaviour */}
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">6. Behaviour</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">7. Property Damages</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">8. Force Majeure Event</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">9. Negligence</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">10. Amendment Charges</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">11. Use of Electronic Devices and Phones</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">12. Arrival and Departure Dates</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">13. Level of English</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">14. Damage to the Property</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">15. Complaints</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">16. Airport Transfers</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">17. Data Protection</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">18. Assignment and Subcontracting</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">19. Disclaimer</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">20. Parents&apos; Visits</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            {/* Section 21: Refunds */}
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">21. Refunds</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 leading-snug mb-4">22. Programme Information</h2>
              <div className="space-y-4">
                <p className="text-sm md:text-[15px] text-gray-500 leading-relaxed">
